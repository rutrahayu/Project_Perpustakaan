...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2021 at 10:27 AM
...
(18, ' Rut Rahayu Br Sinulingga', '2021-11-22', '', 'Kabanjahe', '20510018', 'ayu', 15),
(19, 'Dewi', '2000-02-02', 'P', 'Kabanjahe', 'dewi', 'dewi', 15),
(20, 'Dewi Priani', '2002-05-21', 'P', 'Kabanjahe', 'ayu', 'ayu', 15),
(21, 'Anastasya', '2001-12-08', 'P', 'Kabanjahe', 'tasya', 'tasya', 15);
...
--
ALTER TABLE `detail_peminjaman_buku`
  MODIFY `id_detail_peminjaman_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
ALTER TABLE `peminjaman_buku`
  ...
  ADD CONSTRAINT `peminjaman_buku_ibfk_2` FOREIGN KEY (`id_mhs`) REFERENCES `mahasiswa` (`id_mhs`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
